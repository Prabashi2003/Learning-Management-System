...
private String getMaterialTypeFromFile(String materialPath) {
    ...
    private void initComponents() {
        ...
        courseMaterialTable = new rojeru_san.complementos.RSTableMetro();
        ...
        jPanel1.add(courseComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 30, 460, 30));

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel1.setText("Select Course :");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 30, 100, 30));
        ...
        courseMaterialTable.setRowHeight(30);
        jScrollPane2.setViewportView(courseMaterialTable);
    ...
    private rojeru_san.complementos.RSTableMetro courseMaterialTable;
