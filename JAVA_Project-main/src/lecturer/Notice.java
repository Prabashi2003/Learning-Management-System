...
public class Notice extends javax.swing.JFrame implements CRUD_Operation_Interface{
    ...
    public void getDetails(RSTableMetro table, String searchValue, String lecId) {
        String sql = "SELECT * FROM notice where concat(notice_id) like ? order by notice_id ASC";
    ...
    private void btn_searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_searchActionPerformed
        ...
        if(txt_search.getText().isEmpty()){
            ...
            getDetails(tbl_medical, txt_search.getText(),"");
        }
