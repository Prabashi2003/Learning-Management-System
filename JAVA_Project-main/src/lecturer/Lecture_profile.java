...
public class Lecture_profile extends javax.swing.JFrame {
    ...
    public void update(String name, String email, String phone, String userId) {
        ...
        try ( Connection con = dbconnection.getConnection();  
            ...
            if (rowsAffected > 0) {
                ...
                JOptionPane.showMessageDialog(null, "No changes were made to the profile.");
            }
    ...
    public void changeProfilePicture() {
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            String destinationFolder = "src/SystemImages/";  //Sets destination folder to "src/SystemImages/"
            String newFileName = "profile_" + userId + "_" + selectedFile.getName(); // Unique filename
            File destinationFile = new File(destinationFolder + newFileName); //Creates a File object for the destination
...
//                Files.copy(selectedFile.toPath(), destinationFile.toPath(), StandardCopyOption.REPLACE_EXISTING);
                ...
                Image img = icon.getImage().getScaledInstance(lecPhoto.getWidth(), lecPhoto.getHeight(), Image.SCALE_SMOOTH);//lecphoto label eke size eka aragena ekata fit wena widiyta image eka resize krnwa
                lecPhoto.setIcon(new ImageIcon(img)); //Sets it as the new icon
    ...
    private void btn_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_updateActionPerformed
        String currentName = lecName.getText();
      String currentEmail = lecEmail.getText();
      String currentPhone = lecPhone.getText();
      update(currentName, currentEmail, currentPhone, userId);
